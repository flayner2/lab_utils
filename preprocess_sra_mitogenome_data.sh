...
do
        ...
        # Sort the SAM file, removing the unsorted SAM
        ...
        samtools fastq -1 ${outdir}/${id}_enriched_1.fq.gz -2 ${outdir}/${id}_enriched_2.fq.gz -0 /dev/null -s /dev/null -n ${outdir}/${id}_bwa_out.sorted.filtered.bam
